...
A full list of publications and other contributions is available in my <div id="pdf">
  <object width="400" height="500" type="application/pdf" data="/pdfs/shortCV.pdf" id="pdf_content">
    <p>Insert your error message here, if the PDF cannot be displayed.</p>
  </object>
</div>>. The name of students that work under my supervision are *italicized*.
